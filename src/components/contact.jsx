...
function Contact() {
  return (
    <div>
        <Navbar/>
      <section className="text-white body-font bg-green-100 mx-11">
        <div className="container flex flex-col md:flex-row lg:max-w-5xl w-full px-5 py-12 md:py-24 mx-auto section" id="contact-form">
          <div className="md:w-1/3 w-full text-white">
            ...
            <p className="leading-relaxed text-xl text-gray-900">
              ...
              <a href="https://neboffical.com" className="font-medium text-blue-600 hover:underline"> click here to reveal our protected email address</a>
            </p>
            <p className="leading-relaxed text-xl text-gray-900 mt-8">Connect with us on social media:</p>
            <span className="inline-flex mt-6 justify-center sm:justify-start">
              <a className="text-gray-500 hover:text-gray-900" target="_blank" rel="noopener noreferrer" href="https://twitter.com/nebofficial">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                </svg>
              </a>
              <a className="ml-3 text-gray-500 hover:text-gray-900" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/nebofficial/">
          ...
          <div className="md:w-2/3 w-full mt-10 md:mt-0 md:pl-28">
            ...
            <form action="" method="post">
              ...
              <p className="leading-relaxed text-xl text-gray-900 mt-8">
                We use VeilMail.io to <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://nebofficial.com">hide email address from spammers</a>
              </p>
            </form>
          </div>
        </div>
